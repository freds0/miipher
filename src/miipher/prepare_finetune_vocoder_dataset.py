...
def main(miipher_path: Path):
    ...
    vocoder = HiFiGANXvectorLightningModule.load_from_checkpoint("/home/christopher/Repos/miipher/shulby_miipher/miipher/vocoder_finetuned_v2.ckpt", map_location='cpu')
    vocoder.eval()
...
if __name__ == "__main__":
    ckpt_path = Path("/home/christopher/Repos/miipher/shulby_miipher/miipher/miipher_v2.ckpt")
    main(ckpt_path)
